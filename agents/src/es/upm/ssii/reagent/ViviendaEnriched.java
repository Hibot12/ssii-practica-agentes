...
public class ViviendaEnriched {
    ...
    public String fechaPublicadoTexto;
    public String aeropuertoMasCercano;
    public int distanciaAeropuertoKm;
    ...
    public String prediccionWeka;
    public String claseFinal;
    public int puntuacionNLP;
}
